...
import ir.mostafa.launcher.icons.Candle
import ir.mostafa.launcher.icons.ColorLayer
import ir.mostafa.launcher.icons.Dentistry
import ir.mostafa.launcher.icons.Eyeglasses
import ir.mostafa.launcher.icons.Monument
import ir.mostafa.launcher.icons.StaticLauncherIcon
import ir.mostafa.launcher.icons.Stethoscope
...
interface Location : SavableSearchable {
    ...
    fun toAndroidLocation(): AndroidLocation =
        AndroidLocation("LocationProvider").apply {
    ...
    fun distanceTo(
        latitude: Double,
        longitude: Double,
        locationProvider: String = "LocationProvider"
    ): Float =

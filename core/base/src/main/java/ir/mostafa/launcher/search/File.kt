...
interface File : SavableSearchable {
    ...
    override fun getPlaceholderIcon(context: Context): StaticLauncherIcon {
        val (resId, bgColor) = when {
            ...
            mimeType.startsWith("video/") -> R.drawable.ic_file_video to R.color.purple
                ...
                "application/vnd.ir.mostafa.launcher.backup" -> R.drawable.ic_file_backup to R.color.brown
                "application/vnd.ir.mostafa.launcher.theme" -> R.drawable.ic_file_theme to R.color.amber
    ...
    fun getFileType(context: Context): String {
        ...
        if (mimeType == "application/vnd.ir.mostafa.launcher.backup") {
            return context.getString(
                R.string.file_type_launcherbackup,
                context.getString(R.string.app_name)
            )
        }
        if (mimeType == "application/vnd.ir.mostafa.launcher.theme") {
            return context.getString(
